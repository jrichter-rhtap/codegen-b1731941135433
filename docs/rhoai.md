...
3) Access the `workbench` named `codegen-b1731941135433-notebook`.
...
5) In the terminal, run `cd codegen-b1731941135433` to navigate to your sample app's directory.
